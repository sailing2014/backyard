                    ...
                    <table width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="280" align="left">名称</th>
                                <th width="80" align="left">范围</th>
                                <th width="50" align="left">分类ID</th>
                        ...
                        <tbody>
                            <?php foreach ($list as $t) { ?>
                                <tr height="25">
                                    ...
                                    <td align="left"><?php echo $t['start'] . "~" . $t["end"]; ?></td>
                                    <td align="left">
                                        <?php echo $t['cat_id'] ?>
                                    </td>
                                    <td align="left"><?php echo date('Y-m-d H:i:s', $t['addtime']) ?></td>
                                    <td align="left">
                                        <a href="<?php echo purl('index/show/', array('month' => $t['start'])) ?>" target="_blank">查看</a> | 
