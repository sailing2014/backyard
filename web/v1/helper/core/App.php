...
require SYS_ROOT.'system/DoitPHP.php';
...
abstract class App {
	 ...
	 * 显示404错误提示
	 */
	public static function display_404_error($id=0) {
	...
	public static $core_class_array = array(
		...
		'http_client'	=> 'lib/http_client.class.php',
		'session_db'    => 'lib/session_db.class.php',
	);
	...
	public static function auto_load($class_name) {
		if (isset(self::$core_class_array[$class_name])) {				
            ...
            if (is_file(CONTROLLER_DIR . $class_name . '.php')) {
                self::load_file(CONTROLLER_DIR . $class_name . '.php');
            } else {
                Controller::halt('The Controller file: ' . $class_name . ' is not exists!');
            }
        } else {
